...
//    final Usuario colaborador_admin = new Usuario("em", "nom",  "pwd", "ADMIN");
//    final Usuario colaborador_user = new Usuario("em1", "nom", "pwd", "USER");
//
//    @Inject
//    CargoDao cargoDao;
//    @Inject
...
//        logger.info(usuarioDao.save(this.colaborador_admin).toString());
//        logger.info(usuarioDao.save(this.colaborador_user).toString());
//    }
//
//
//    @Test
