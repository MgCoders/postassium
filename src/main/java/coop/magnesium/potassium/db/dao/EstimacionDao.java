...
import coop.magnesium.potassium.db.entities.Estimacion;
...
public class EstimacionDao extends AbstractDao<Estimacion, Long> {
    ...
    public List<EstimacionProyectoTipoTareaXCargo> findEstimacionProyectoTipoTareaXCargo(Proyecto proyecto, TipoTarea tipoTarea) {
        Query query = em.createQuery("" +
                "select new coop.magnesium.potassium.api.dto.EstimacionProyectoTipoTareaXCargo(e.proyecto,ed.tipoTarea,ed.cargo, sum(ed.precioTotal), sum(ed.duracion)) " +
